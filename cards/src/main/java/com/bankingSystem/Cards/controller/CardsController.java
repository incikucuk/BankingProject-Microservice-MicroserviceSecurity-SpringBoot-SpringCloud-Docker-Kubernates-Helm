package com.bankingSystem.Cards.controller;

import com.bankingSystem.Cards.constants.CardConstant;
import com.bankingSystem.Cards.dto.CardDto;
import com.bankingSystem.Cards.dto.CardsContactInfoDto;
import com.bankingSystem.Cards.dto.ErrorResponseDto;
import com.bankingSystem.Cards.dto.ResponseDto;
...
@Tag(
        name = "CRUD REST APIs for Cards in Banking System",
        description = "CRUD REST APIs in BankingSystem to CREATE, UPDATE, FETCH AND DELETE card details"
)
@RestController
...
public class CardsController {
    ...
    @Operation(
            ...
            description = "REST API to create new Card inside BankSys"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
